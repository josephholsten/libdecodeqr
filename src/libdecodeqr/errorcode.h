...
#define QR_IMAGEREADER_NOT_FOUND_FINDER_PATTERN 0x0100
#define QR_IMAGEREADER_NOT_FOUND_CODE_AREA 0x0200
#define QR_IMAGEREADER_NOT_DETERMINABLE_CODE_AREA 0x0400
